...
#pragma warning restore xUnit1012
    ...
    {
        // Act
        var result = CreateSut ( ).ConvertStringToUlongOrDefault ( input ,
                                                                   defaultValue ) ;
    ...
    public void ConvertStringToUlongOrDefault_ShouldCallTryParse ( )
    {
        ...
        // Act
        mockConverter.ConvertStringToUlongOrDefault ( text ,
                                                      defaultValue ) ;

        // Assert
        mockConverter.Received ( 1 ).ConvertStringToUlongOrDefault ( text ,
                                                                     defaultValue ) ;
    }
