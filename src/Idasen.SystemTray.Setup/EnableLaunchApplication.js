...
var checkboxText = "Launch Idasen.SystemTray";  // Text for the checkbox on the finished dialog
var filename = "Idasen.SystemTray.exe";   // The name of the executable to launch - change this to match the file you want to launch at the end of your setup
