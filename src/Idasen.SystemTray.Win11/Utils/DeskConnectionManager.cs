...
public sealed class DeskConnectionManager : IDeskConnectionManager
{
    ...
    public bool IsConnected => CurrentDesk is not null ;

    public IDesk ? CurrentDesk { get ; private set ; }
    ...
    public async Task ConnectAsync ( CancellationToken cancellationToken )
    {
        try
        {
                                                                              ...
                                                                              try
                                                                              {
                                                                                  ...
                                                                                  var deviceName =
                                                                                      _settingsManager.CurrentSettings
                                                                                                      ...
                                                                                                      .DeviceName ;
                                                                                  _logger
                                                                                     .Debug ( "[{DeviceName}] Trying to connect to Idasen Desk..." ,
                                                                                              deviceName ) ;
                                                                                  ...
                                                                                  _logger
                                                                                     .Warning ( "Connection attempt failed - desk not found or unavailable" ) ;
                                                                                  return false ;
                                                                              }
                                                                              catch ( Exception e )
                                                                              {
                                                                                  var deviceName =
                                                                                      CurrentDesk?.DeviceName ??
                                                                                      _settingsManager.CurrentSettings
                                                                                                      .DeviceSettings
                                                                                                      .DeviceName ;
                                                                                  _logger.Warning ( e ,
            ...
            if ( ! success ) HandleConnectionFailed ( ) ;
        }
        catch ( Exception e )
        {
            var deviceName = CurrentDesk?.DeviceName ?? "Unknown" ;
            _logger.Error ( e ,
