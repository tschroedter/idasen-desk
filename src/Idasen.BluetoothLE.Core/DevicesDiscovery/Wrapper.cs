...
namespace Idasen.BluetoothLE.Core.DevicesDiscovery
{
        ...
        : IWrapper
    {
                       ...
                       [NotNull] IStatusMapper                         statusMapper)
        {
            ...
            Guard.ArgumentNotNull(deviceFactory,   nameof(deviceFactory));
            Guard.ArgumentNotNull(dateTimeFactory, nameof(dateTimeFactory));
            Guard.ArgumentNotNull(received,        nameof(received));
            Guard.ArgumentNotNull(stopped,         nameof(stopped));
            Guard.ArgumentNotNull(statusMapper,    nameof(statusMapper));
            ...
            var fromReceivedEvent =
                Observable.FromEventPattern<BluetoothLEAdvertisementReceivedEventArgs>(_watcher, "Received");
            var fromStoppedEvent =
                Observable.FromEventPattern<BluetoothLEAdvertisementWatcherStoppedEventArgs>(_watcher, "Stopped");
