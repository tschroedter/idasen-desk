...
## [v0.1.495](https://github.com/tschroedter/idasen-desk/compare/v0.1.492...v0.1.495) - 2026-07-08

Changes

- Fix: height update not working in icon
- Fix: Remove unnecessary connection notification
